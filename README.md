...
- The YAML currently targets `esp32-s3-devkitc1-n16r8` with `W5500` Ethernet.
- The file declares `min_version: 2025.11.0` for ESPHome.
- Verify hardware pin mapping before adapting this configuration for other boards.

## License

Use this repository according to your project or deployment needs. Add a license file if you want to publish formal reuse terms.
